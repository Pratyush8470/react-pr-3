...
export default function Why () {
  ...
  return (
    <> 
      ...
      <svg xmlns="http://www.w3.org/2000/svg" className="w-14 fill-gray-300 inline" viewBox="0 0 475.082 475.081">
      ...
      <div className="mt-8">
        <p className="text-base">Exceptional Service: Prompt Delivery and Enjoyable Dining Experience.</p>
